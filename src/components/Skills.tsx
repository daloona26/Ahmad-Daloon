...
const Skills: React.FC = () => {
  const skills = [
    ...
    { name: 'Next.js', level: 80, color: 'bg-gray-800 dark:bg-gray-200' }, // Specific dark mode color for Next.js
    { name: 'Tailwind CSS', level: 92, color: 'bg-teal-500' },
    { name: 'Django', level: 75, color: 'bg-green-600' },
  ];

  return (
    <section id="skills" className="py-20 bg-white dark:bg-gray-800 transition-colors duration-500">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
            {skills.map((skill) => (
              <div
                key={skill.name}
                className="bg-gray-50 dark:bg-gray-700 p-4 rounded-xl text-center hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-300 group cursor-pointer"
              >
